...
// druga varijanta drugog zadatka, sa 3 nivoa pogadjanja
...
public class Main {
	public static void main(String[] args) {
		...
		case 1:
			...
			int nivo1red = rand.nextInt(4);
			int nivo1kolona = rand.nextInt(4);
		...
		case 2:
			...
			int nivo2red = rand.nextInt(7);
			int nivo2kolona = rand.nextInt(7);
		...
		case 3:
			...
			break;
		default:
			System.out.println("Greska prilikom unosa nivoa (1 - 3)");
		}
		input.close();
	}
}
